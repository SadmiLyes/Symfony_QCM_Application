 ...
 */
final class Version20180518064929 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE member (id INT AUTO_INCREMENT NOT NULL, class_room_id INT NOT NULL, student_email VARCHAR(255) NOT NULL, is_confirmed TINYINT(1) DEFAULT \'0\', INDEX IDX_70E4FA789162176F (class_room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE result_qcm (id INT AUTO_INCREMENT NOT NULL, student_id INT DEFAULT NULL, session_id INT DEFAULT NULL, quiz_id INT NOT NULL, mark INT DEFAULT NULL, UNIQUE INDEX UNIQ_53A721FBCB944F1A (student_id), UNIQUE INDEX UNIQ_53A721FB613FECDF (session_id), UNIQUE INDEX UNIQ_53A721FB853CD175 (quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, quiz_id INT DEFAULT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, INDEX IDX_D044D5D4F675F31B (author_id), INDEX IDX_D044D5D4853CD175 (quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, birthday DATE NOT NULL, address VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, gender VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, salt VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
